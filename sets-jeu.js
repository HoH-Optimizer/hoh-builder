...
window.SETS_JEU = {
  ...
  "Enchantress": {"pieces":3,"emplacements":["Hat","Neck","Ring"],"effet":"Défense +5 % et Charge initiale -1 s","bonus":[{"stat":"Defense","valeur":0.05,"type":"pourcentage"},{"stat":"InitialFocusSeconds","valeur":-1,"type":"plat"}]},
  ...
  "Reveler": {"pieces":3,"emplacements":["Hat","Neck","Ring"],"effet":"Dégâts de zone infligés +7,5 % et Charge initiale -1 s","bonus":[{"stat":"AoeDamageAmp","valeur":0.075,"type":"pourcentage"},{"stat":"InitialFocusSeconds","valeur":-1,"type":"plat"}]},
  ...
  "Flapper": {"pieces":3,"emplacements":["Hat","Neck","Ring"],"effet":"Charge initiale -0,5 s","bonus":[{"stat":"InitialFocusSeconds","valeur":-0.5,"type":"plat"}]},
  ...
  "Noble": {"pieces":3,"emplacements":["Hat","Neck","Ring"],"effet":"Charge initiale -1 s","bonus":[{"stat":"InitialFocusSeconds","valeur":-1,"type":"plat"}]},
